...
* [Indexer](official-docs/indexer/README.md)
  ...
  * [Indexer Subgraph Selection Guide](official-docs/indexer/indexer-subgraph-selection-guide.md)
  * [Testnet](official-docs/indexer/testnet/README.md)
    * [Graph Protocol Testnet Docker Compose](official-docs/indexer/testnet/guide.md)
    * [Graph Protocol Testnet Baremetal](official-docs/indexer/testnet/graph-protocol-testnet-baremetal/README.md)
      * [Architecture Considerations](official-docs/indexer/testnet/graph-protocol-testnet-baremetal/1\_architectureconsiderations.md)
      * [Deploy and Configure Database](official-docs/indexer/testnet/graph-protocol-testnet-baremetal/2\_deployandconfigurepostgresdatabase.md)
      * [Deploy and Configure Graph-node](official-docs/indexer/testnet/graph-protocol-testnet-baremetal/3\_deployandconfiguregraphnode.md)
      * [Deploy and Configure Indexer stack](official-docs/indexer/testnet/graph-protocol-testnet-baremetal/4\_deployandconfiguregraphindexerstack.md)
  * [Monitoring](official-docs/indexer/monitoring/README.md)
    * [Ethereum Node Chainhead Monitoring - no third parties](official-docs/indexer/monitoring/localethereumnodechainheadmonitoring.md)
  * [Best Practices](official-docs/indexer/tips-and-tricks/README.md)
    * [Failed subgraphs - Manually Closing Allocations](official-docs/indexer/tips-and-tricks/manuallyclosingallocationsforfailedsubgraphs.md)
